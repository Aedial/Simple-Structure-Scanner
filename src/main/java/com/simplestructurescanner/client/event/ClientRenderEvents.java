...
public class ClientRenderEvents {
    ...
    private void drawCaptureSelection(EntityPlayer player, float partialTicks) {
        if (!StructureCaptureClientController.hasSelection()) return;

        BlockPos firstCorner = StructureCaptureClientController.getFirstCorner();
        ...
        RenderGlobal.drawSelectionBoundingBox(bounds.offset(-cameraX, -cameraY, -cameraZ), 1.0F, 0.15F, 0.15F, 0.9F);
